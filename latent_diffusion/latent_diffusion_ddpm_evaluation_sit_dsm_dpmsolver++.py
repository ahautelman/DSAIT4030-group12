...
vae_checkpoint_path = f"{checkpoint_dir}/VAE_DSM_step_200000.pt"
diffusion_checkpoint_path = f"/media/remcohuijsen/Expansion/generative_modeling_checkpoints/latent_diffusion_ddpm_dsm_sit_checkpoint_10000_.pt"

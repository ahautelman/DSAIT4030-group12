...
project_root = os.path.abspath(os.path.join(current_dir, "..")) # Goes up one folder to DSAIT4030-group12

if project_root not in sys.path:
    sys.path.insert(0, project_root)
    
colab_path = '/content/drive/MyDrive/DSAIT4030-group12'
if os.path.exists(colab_path) and colab_path not in sys.path:
    sys.path.insert(0, colab_path)
    
sit_path = '/content/drive/MyDrive/SiT'
if os.path.exists(sit_path) and sit_path not in sys.path:
    sys.path.insert(0, sit_path)
...
vae_checkpoint_path = "/content/drive/MyDrive/DSAIT4030-group12/checkpoints/VAE_KL_step_200000.pt"
diffusion_checkpoint_path = "/content/drive/MyDrive/DSAIT4030-group12/latent_diffusion_ddpm_kl_sit_checkpoint.pt"
...
save_checkpoint_milestone_every = 10000
print_loss_every = 25
#############################################################################
...
for i in range(start_iteration, iterations):
    ...
    if save_checkpoint_every and (i % save_checkpoint_every == 0) and i != start_iteration:
